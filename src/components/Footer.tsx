        ...
        <>
            <div className="w-full fixed inset-x-0 bottom-0 h-24 text-white bg-black bg-opacity-30">
                ...
                <div className="full-container flex mt-5 space-x-2 justify-left">
                    ...
                    <Tooltip title="Follow me on GitHub!" duration={100} animation="scale" theme="light"><a href="https://github.com/caoboyeehaw/" target="_blank">
                    ...
                    <Tooltip title="Connect with me on LinkedIn!" duration={100} animation="scale" theme="light"><a href="https://www.linkedin.com/in/dylanhoangcao/" target="_blank">
                    <img src="https://iconsplace.com/wp-content/uploads/_icons/ffffff/256/png/linkedin-icon-18-256.png" className="mt-0.5 w-4 h-4" /> 
                    </a></Tooltip>

                    <Tooltip title="Chat with me on Discord!" duration={100} animation="scale" theme="light"><a href="https://discord.gg/3bd6NdzMV2" target="_blank">
                    ...
                    <Tooltip title="Follow me on Instagram!" duration={100} animation="scale" theme="light"><a href="https://instagram.com/caoboyeehaw/" target="_blank">
                    ...
                    <Tooltip title="Contact me via Email!" duration={100} animation="scale" theme="light"><a href="mailto:caoboycontactcao@gmail.com">
