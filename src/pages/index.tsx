      ...
      <Head>
        ...
        <main>
            ...
            {/* https://www.npmjs.com/package/react-tippy */}
                ...
                I&apos;m a 23-year old, Seattle-born, Vietnamese-American software developer with creative tendencies. I code projects in my freetime and am looking forward towards contributing to software&apos;s crazy future! My passions are game design, web development, machine learning, and data science.
                </div>
                </div>
            </div>
